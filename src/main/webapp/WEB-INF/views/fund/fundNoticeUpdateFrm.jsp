...
<body>
    ...
    <div class="detail-container">
		...
		<div class="notice-wrap">
            <div class="notice">  
                <form class="form" action="/updateFundNotice.do" method="post" enctype="multipart/form-data" >
                    <table class="table">
                        <tr>
                            <th colspan="1" style="width:150px;">제목</th>
                            <td colspan="3">
                                <input type="text" name="fnTitle" class="fnTitle" style="width:500px;" value="${fn.fnTitle }">
                            </td>
                        </tr>
                        <tr>
                            <th>카테고리</th>
                        ...
                        <tr>
                            ...
                            <td colspan="3">
                            	...
                            	<c:choose>
                            		<c:when test="${empty fn.fnFilepath }">
                            			<input type="file" name="file">
                            			<input type="hidden" name="oldFile" value="none">
                            		</c:when>
                            		<c:otherwise>
                            			<input type="hidden" name="oldFile" value="${fn.fnFilepath }">
                            			<img class="img" src="/resources/image/fund/notice/${fn.fnFilepath}">
                            			<input type="file" name="file" value="${fn.fnFilepath }" style="display:none;"  >
                            			<button type="button" class="fileDelete" id="fileDelete">삭제</button>
                        ...
                        <tr>
                            <td colspan="4">
                                <textarea name="fnContent" id="fnContent" class="fnContent">${fn.fnContent }</textarea>                            </td>
                        </tr>
                    </table>            
                    <input type="hidden" name="memberId" value="${f.memberId }" >
                    <input type="hidden" name="fundNo" value="${f.fundNo }" >
                    <input type="hidden" name="fnNo" value="${fn.fnNo }" >
                    <input type="submit" id="submit" class="btn btn-outline-primary" value="새소식 수정하기">
                </form>
 	 ...
 	 $("#fnContent").summernote({
		...
		function uploadImage(file,editor){
	 	...
	 	$("#fileDelete").on("click",function(){
	 		...
	 		$(this).prev().prev().prev().prev().val("none");
	 	});
