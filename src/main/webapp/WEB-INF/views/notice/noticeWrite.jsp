 ...
 <script>
      ...
      //제출하기 검사
        $("input[type='submit']").on("click",function(e){
            ...
            /*
            console.log($("input[name='noticeType']").val());
            console.log($("input[name='noticeWriter']").val());
            console.log($("input[name='noticeTitle']").val());
            console.log("filepath:"+ $("input[name='noticeFilepath']").val());
            ...
            console.log($("select[name='couponNo']").val());
           */
        });
