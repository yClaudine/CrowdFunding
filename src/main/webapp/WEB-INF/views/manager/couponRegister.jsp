...
<body>
	...
	<div class="content-wrap">
		...
		<div class="main-content">
			<div class="btn btn-primary">쿠폰등록</div>
			<form action="/insertCoupon.do" method="post">
				<table class="coupon-table">
					<tr>
						<th>쿠폰명</th>
						<td colspan="3"><input type="text" name="couponName"
							placeholder="예시 : [펀딩]5월 10%할인쿠폰" style="width: 100%;"></td>
					</tr>
					<tr>
						<th>유효기간</th>
						<td>
					...
					<td colspan="2"><select name="subTarget">
							<option value="all">전체</option>
					...
					<tr>
						<th>최소 구매금액</th>
						<td><input type="radio" name="price" value="none" id="none">
							<label for="none">미지정</label> <input type="radio" name="price"
							value="fixed" id="fixed"> <label for="fixed">지정</label></td>
						<td><input type="text" name="minPrice" value="0" readonly>원
